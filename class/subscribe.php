    ...
    class Subscribe {
        ...
        public function insert() {
            if($this->name && $this->email && $this->verify_token) {
                $stmt = $this->conn->prepare("INSERT INTO ".$this->subscribersTable."(`name`, `email`, `verify_token`) VALUES (?,?,?)");
        ...
        public function update() {
            if($this->verify_token) {
                $stmt = $this->conn->prepare("UPDATE ".$this->subscribersTable."SET is_verified= ? WHERE verify_token = ?");
        ...
        public function getSubscriber() {
            if($this->email) {
                ...
                $allResult = $stmtSubscriber->num_rows;
                return $subscribersRows;
            }
        }
        ...
        public function verifyToken() {
            if($this->verify_token) {
                ...
                $subscribersRows = $allResult->num_rows;
                return $subscribersRows;
            }
        }
    }
